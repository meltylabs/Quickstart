(() => {
  ...
  const CART_KEY = "ovo-demo-cart-v2";
  const RECENT_KEY = "ovo-recent-products-v1";
  const NEWSLETTER_KEY = "ovo-newsletter-preference-v1";
  const LEGACY_KEYS = {
    cart: "datum-demo-cart-v2",
    recent: "datum-recent-products-v1",
    newsletter: "datum-newsletter-preference-v1",
  };
  ...
  function track(event, properties = {}) {
    ...
    window.dispatchEvent(new CustomEvent("ovo:analytics", { detail: payload }));
  }
  ...
  function header() {
    const nav = [
      ...
      ["sets", "Sets", "bundles.html"],
      ["testing", "Testing", "testing.html"],
      ["journal", "Journal", "notes.html"],
    ];
    ...
    return `
      ...
      <div class="mobile-drawer" data-mobile-drawer data-open="false" role="dialog" aria-modal="true" aria-hidden="true" aria-labelledby="menu-title" inert>
        ...
        <nav class="mobile-nav" aria-label="Mobile navigation">
          ...
          <a href="${path("bundles.html")}">Sets</a>
          <a href="${path("testing.html")}">Testing</a>
          <a href="${path("notes.html")}">Journal</a>
          <a href="${path("faq.html")}">FAQ</a>
          <a href="${path("company.html")}">About OVO Labs</a>
  ...
  function homePage() {
    return `
      <section class="home-hero">
        <div class="shell hero-grid">
          <div class="hero-copy">
            ...
            <h1>A considered collection of <em>peptide compounds.</em></h1>
            <p>Ten distinct compounds and blends, organized for direct comparison. Clear formats, visible testing status, and a quiet path from search to cart.</p>
            <div class="hero-actions">
              <a class="button button-primary" href="${path("catalog.html")}">Shop the collection</a>
              <a class="quiet-link" href="${path("testing.html")}">Review testing status ${icons.arrow}</a>
            </div>
          </div>
      ...
      <section class="section category-index-section">
        <div class="shell">
          <div class="section-head category-section-head">
            ...
            <p>Browse by research area, or search for a molecule or OVO code when you know exactly where to begin.</p>
          </div>
          ${categoryRail()}
        </div>
      </section>
      <section class="section collection-feature-section">
        <div class="shell">
          <div class="section-head">
            <div>
              <p class="eyebrow">The first edit</p>
              <h2>Begin with the molecule.</h2>
            </div>
      ...
      <section class="section testing-feature-section">
        <div class="shell testing-feature">
          <div class="testing-feature-copy">
            ...
            <a class="text-link quiet-link" href="${path("testing.html")}">Read the testing framework ${icons.arrow}</a>
          </div>
      ...
      <section class="brand-principle">
        <div class="shell brand-principle-inner">
          <p class="eyebrow">The OVO principle</p>
          <h2>Quiet standards. <em>Clear boundaries.</em></h2>
          <p>Product information stays composed, and missing evidence stays visible.</p>
          <a class="quiet-link" href="${path("company.html")}">About OVO Labs ${icons.arrow}</a>
        </div>
      </section>
      ${newsletter()}
    `;
        ...
        <section class="shell pdp-grid">
          <div class="pdp-gallery">
            ...
            <div class="pdp-thumbnails" aria-label="Product concept views">
              ...
              <button class="pdp-thumb" type="button" data-media-view="scale" data-media-zoom="1" data-media-src="${path("assets/ovo-hero-still.webp")}" data-media-alt="Still-life view for ${escapeHtml(product.name)}" aria-label="Show still-life view" aria-current="false">
