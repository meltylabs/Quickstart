      ...
      <section class="home-hero">
        <div class="shell hero-grid">
          ...
          <div class="hero-visual">
            <img src="${path("assets/datum-hero-vials.webp")}" alt="An OVO Labs amber peptide vial with a gold cap resting on a travertine ledge in warm window light" width="1536" height="1024" fetchpriority="high">
          </div>
        </div>
      </section>
